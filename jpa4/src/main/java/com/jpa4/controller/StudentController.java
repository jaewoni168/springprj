...
public class StudentController {
    ...
    public String test9(Model model) {
        model.addAttribute("students", studentRepository.findByDepartmentProfessorsName("이몽룡"));
        return "student/list";
    }

    @RequestMapping("student/test10")
    public String test10(Model model) {
        model.addAttribute("students", studentRepository.findBySugangsLectureTitle("자료구조"));
        return "student/list";
    }

    @RequestMapping("student/test11")
    public List<Student> test11() {
        return studentRepository.findByProfessorNameOrProfessorId(null, 13);
    }

    @RequestMapping("student/test12")
